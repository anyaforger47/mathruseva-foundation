...
MYSQL_CONFIG = {
    'host': 'localhost',
    'user': 'root',
    'password': 'NehaJ@447747',  # Your MySQL password
...
# (All the volunteer, camp, donation, analytics, PDF routes from secure_app.py)
...
if __name__ == '__main__':
    print("========================================")
    print("  Mathruseva Foundation")
    print("  NGO Management System")
    print("========================================")
