-- MySQL 9.6 compatible database setup for Mathruseva Foundation

-- Step 1: Create database
DROP DATABASE IF EXISTS mathruseva_foundation;
CREATE DATABASE mathruseva_foundation;
...
-- Step 4: Create camp_volunteers table
...
-- Step 5: Create medical_summary table
