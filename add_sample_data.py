...
def add_sample_data():
    try:
        ...
        if conn:
            ...
            print(f"  - Volunteers: {len(volunteers_data)} added")
            print(f"  - Camps: {len(camps_data)} added")
            print(f"  - Donations: {len(donations_data)} added")
            print(f"  - Attendance records: {len(attendance_data)} added")
